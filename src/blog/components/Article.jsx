  ...
  return (
    <article className="border rounded-lg border-white mx-12 text-white px-4 py-4 mb-8 md:flex md:gap-4">
      ...
      <div className="md:w-4/6 lg:w-full">
        <h2 className="text-4xl mb-2 truncate">{ article.title }</h2>
        ...
        <button onClick={ onClickRead } className="bg-gray-600 px-4 py-2 mt-2 hover:cursor-pointer hover:bg-gray-400">Leer <FontAwesomeIcon icon={ faArrowRight } /></button>
      </div>
    </article>
  )
}
